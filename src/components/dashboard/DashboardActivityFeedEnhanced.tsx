...
interface DashboardActivityFeedEnhancedProps {
  recentAssessments: number;
  totalStudents: number;
  studentsNeedingAttention: number;
}

const DashboardActivityFeedEnhanced: React.FC<DashboardActivityFeedEnhancedProps> = ({
  recentAssessments,
  totalStudents,
...
export default DashboardActivityFeedEnhanced;
