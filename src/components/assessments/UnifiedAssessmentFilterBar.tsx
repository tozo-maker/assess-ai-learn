  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6 space-y-4">
          ...
          {onViewModeChange && (
            <div className="flex border border-gray-300 rounded-lg overflow-hidden">
              <Button
                ...
                className={`rounded-none ${viewMode === 'grid' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}
              >
              ...
              <Button
                ...
                className={`rounded-none ${viewMode === 'list' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}
              >
      ...
      <div className="flex items-center justify-between text-sm text-gray-600">
        <span>
          Showing {filteredCount} of {totalCount} assessments
        </span>
        {hasActiveFilters && (
          <Button
            variant="ghost"
